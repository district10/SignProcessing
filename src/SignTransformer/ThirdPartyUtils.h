#ifndef THIRD_PARTY_UTILS_H
#define THIRD_PARTY_UTILS_H
...
namespace ThirdPartyUtils {
    ...
    // copied from: http://stackoverflow.com/questions/26279853/how-to-store-all-the-pixels-within-a-rotatedrect-to-another-matrix
